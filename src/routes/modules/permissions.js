...
/**
 * @type        {Array}
 * @description define all route for permission
 * Route properties
 *
 * meta: {
...
export default [
    {
        path: '/permissions',
        component: AsyncComponent(()=> import('../../pages/permissions').then(module=>module.default)),
        exact: true,
        meta: {title: 'Quyền',apiPath},
        child: [
            {
                path: 'create',
                component: AsyncComponent(()=>import('../../pages/permissions/create').then(module=>module.default)),
                exact: true,
                meta: {title: 'Thêm mới quyền',apiPath}
            },
            {
                path: 'edit/:id',
                component: AsyncComponent(()=>import('../../pages/permissions/edit').then(module=>module.default)),
                exact: true,
                meta: {title: 'Cập nhật quyền',apiPath}
            }
        ]
    },
];